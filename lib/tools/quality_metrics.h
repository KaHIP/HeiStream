...
public:
	...
	float getFennelWeight(PartitionConfig & partition_config);
	EdgeWeight fennel_objective(PartitionConfig & partition_config, graph_access & G, int * partition_map, double fennel_gamma, double fennel_alpha);
	EdgeWeight fennel_objective(PartitionConfig & partition_config, graph_access & G, double fennel_gamma, double fennel_alpha);
	EdgeWeight ghost_edge_cut(const PartitionConfig & config, graph_access & G);
