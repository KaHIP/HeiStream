...
void graph_extractor::extract_block(graph_access& G, graph_access& extracted_block,
                                    PartitionID block, std::vector<NodeID>& mapping,
...
void graph_extractor::extract_two_blocks(graph_access& G, graph_access& extracted_block_lhs,
        ...
        if (G.getPartitionIndex(node) == lhs) {
            ...
            forall_out_edges(G, e, node) {
                ...
                if (G.getPartitionIndex(target) == lhs) {
                    EdgeID new_edge =
                        extracted_block_lhs.new_edge(new_node, reverse_mapping_lhs[target]);
            ...
            forall_out_edges(G, e, node) {
                ...
                if (G.getPartitionIndex(target) == rhs) {
                    EdgeID new_edge =
                        extracted_block_rhs.new_edge(new_node, reverse_mapping_rhs[target]);
...
void graph_extractor::extract_two_blocks_connected(graph_access& G, std::vector<NodeID> lhs_nodes,
                                                   std::vector<NodeID> rhs_nodes, PartitionID lhs,
                                                   PartitionID rhs, graph_access& pair,
