...
// iterator for
#define forall_boundary_nodes(boundary, n)                                                        \
    {                                                                                             \
        is_boundary_node_hashtable::iterator iter;                                                \
        NodeID n;                                                                                 \
        for (iter = boundary.internal_boundary.begin(); iter != boundary.internal_boundary.end(); \
             iter++) {                                                                            \
            n = iter->first;
