...
int initial_refinement::optimize(Config& config, graph_access& G, EdgeWeight& initial_cut) {
    ...
    partition_config.local_multitry_fm_alpha =
        partition_config.initial_partition_optimize_multitry_fm_alpha;
    partition_config.local_multitry_rounds =
