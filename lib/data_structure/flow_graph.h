...
struct rEdge {
    ...
    rEdge(NodeID source, NodeID target, FlowType capacity, FlowType flow,
          EdgeID reverse_edge_index) {
        this->source = source;
        this->target = target;
...
inline NodeID flow_graph::getEdgeCapacity(NodeID source, EdgeID e) {
#ifdef NDEBUG
...
inline void flow_graph::setEdgeFlow(NodeID source, EdgeID e, FlowType flow) {
#ifdef NDEBUG
...
inline FlowType flow_graph::getEdgeFlow(NodeID source, EdgeID e) {
#ifdef NDEBUG
...
inline NodeID flow_graph::getEdgeTarget(NodeID source, EdgeID e) {
#ifdef NDEBUG
...
inline EdgeID flow_graph::getReverseEdge(NodeID source, EdgeID e) {
#ifdef NDEBUG
