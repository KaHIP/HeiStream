...
int parse_parameters(int argn, char **argv, 
        ...
        struct arg_lit *use_fennel_edgecut_objectives        = arg_lit0(NULL, "use_fennel_edgecut_objectives", "Use Fennel objetcive function in a first label propagation refinement and then use Edge-cut as gain function in a further label propagation refinement. (Default: disabled)");
	...
	// translation of graphs
		...
		mh_print_log,mh_sequential_mode, mh_optimize_communication_volume, mh_enable_tabu_search,
                ...
                k, imbalance, preconfiguration, time_limit, enforce_balance, balance_edges, integrated_mapping,
...
//                }
        ...
        if (num_streams_passes->count > 0) {
                ...
                partition_config.num_streams_passes = num_streams_passes->dval[0];
        }
