...
██   ████  ██████  ██████  ███████
    ...
    int ret_code = parse_parameters_node(argn, argv, partition_config, graph_filename,
    ...
    core::pipeline::run_stream_engine(StreamMode::Node, partition_config, graph_filename);
